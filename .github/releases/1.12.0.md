...
- Fixes the high-CPU failure after disconnected SSH sessions by updating
  ...
  promptly ([#608](https://github.com/snowie2000/chisel/issues/608)).
...
See [Upgrading to 1.12](https://github.com/snowie2000/chisel#upgrading-to-112) for
configuration details and the
[full 1.12 review](https://github.com/snowie2000/chisel/blob/master/.github/releases/1.12-changes.md)
